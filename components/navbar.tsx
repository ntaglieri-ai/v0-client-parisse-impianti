      ...
      >
        ...
        <div className="md:hidden flex items-center gap-2">
          ...
          <a
            ...
            className="p-2 rounded-full bg-[#25D366] text-white hover:bg-[#1fb855] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] min-w-[44px] min-h-[44px] flex items-center justify-center"
          >
