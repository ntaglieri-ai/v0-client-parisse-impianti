...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-4 pb-10 sm:py-20 w-full overflow-x-hidden">
        <div className="w-full sm:max-w-2xl lg:max-w-4xl">
          {/* Removed: Badge */}

          <h1
            className="font-black text-[2rem] sm:text-5xl md:text-6xl lg:text-7xl text-white"
          ...
          <p className="text-gray-400 max-w-xl mt-6 text-[0.9rem] sm:text-lg leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-8">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-orange-500 text-white font-semibold text-sm hover:bg-orange-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0d1117] min-h-[44px] w-full sm:w-auto"
            >
